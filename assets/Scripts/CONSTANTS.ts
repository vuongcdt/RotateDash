...
export const SET_HAS_TOUCH: string = 'SET_HAS_TOUCH';
export const SET_DIS_TOUCH: string = 'SET_DIS_TOUCH';
...
export const PLAY_TOUCH_SOUND: string = 'PLAY_TOUCH_SOUND';
...
export const MOVE_OBSTACLE: string = 'MOVE_OBSTACLE';
